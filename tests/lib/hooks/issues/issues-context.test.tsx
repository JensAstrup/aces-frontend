...
const TestComponent: React.FC = () => {
  const { issues, currentIssue, setCurrentIssue, isLoading, loadIssuesForViews } = useIssues()
  return (
    <div>
      ...
      <button onClick={loadIssuesForViews}>Load Issues</button>
    </div>
  )
}
...
describe('IssuesProvider', () => {
  beforeEach(() => {
    ...
    mockUseTeams.mockReturnValue({ selectedTeam: { id: 'team1' } } as ReturnType<typeof useTeams>)
  })
